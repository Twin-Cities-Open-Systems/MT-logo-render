...
1. **HEE Decision Compatibility**: Respect HEE decision history and constraints
1. **HEE Governance Compliance**: Maintain HEE governance rules during fixes
1. **HEE Context Preservation**: Preserve HEE execution context across operations
1. **HEE Rollback Guarantee**: Automatic rollback for any HEE compliance failure
