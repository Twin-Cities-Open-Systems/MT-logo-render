...
1. HEE release candidate build generation
1. HEE comprehensive testing
1. HEE state capsule validation and signing
...
1. HEE cryptographic signing
1. HEE Git tag creation
1. HEE GitHub release creation
1. HEE distribution channel updates
