...
1. Enforces dependency-aware admissibility
1. Schedules work against a constrained human operator
1. Records all state transitions as durable, replayable events
1. Produces execution metrics derived exclusively from event history
