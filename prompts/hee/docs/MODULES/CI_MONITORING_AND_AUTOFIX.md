...
1. **Constraint Checking**: Respect project constraints from capsule
1. **Decision Preservation**: Maintain decision history during fixes
1. **Context Stability**: Preserve critical context across operations
