...
1. **Normalize**: Keys sorted, colors standardized, arrays ordered
1. **Validate**: Required fields, type safety, constraint checking
1. **Hash**: SHA256 of canonical JSON for deterministic IDs
